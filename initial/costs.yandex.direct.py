...
# * YANDEX_DIRECT.ACCESS_TOKEN - Access Token для приложения, имеющего доступ к статистике нужного кабинета (или несколько - через запятую, порядок как у логина)
...
# обработка ошибок при добавлении данных
        ...
        print (LOGIN + " | " + date_since + "=>" + date_until + ": " + str(len(data)))
