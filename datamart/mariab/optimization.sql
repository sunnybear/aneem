-- raw_ym_visits
IF EXISTS(SELECT raw_ym_visits FROM INFORMATION_SCHEMA.TABLES WHERE table_name LIKE 'raw_ym_visits')
THEN
...
END IF;
-- raw_ym_visits_goals
IF EXISTS(SELECT raw_ym_visits_goals FROM INFORMATION_SCHEMA.TABLES WHERE table_name LIKE 'raw_ym_visits_goals')
THEN
...
END IF;
-- raw_ym_costs
IF EXISTS(SELECT raw_ym_costs FROM INFORMATION_SCHEMA.TABLES WHERE table_name LIKE 'raw_ym_costs')
THEN
...
END IF;
-- raw_bx_orders
IF EXISTS(SELECT raw_bx_orders FROM INFORMATION_SCHEMA.TABLES WHERE table_name LIKE 'raw_bx_orders')
THEN
...
END IF;
-- raw_bx_orders_goods
IF EXISTS(SELECT raw_bx_orders_goods FROM INFORMATION_SCHEMA.TABLES WHERE table_name LIKE 'raw_bx_orders_goods')
THEN
