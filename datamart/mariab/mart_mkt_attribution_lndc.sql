create view mart_ym_goals_close_lndc as (select
...
create view mart_ym_goals_utm_lndc as (select *
from mart_ym_goals_close_lndc
WHERE rowNum=1);

create view mart_bx_orders_utm_lndc as (select
	id,
	price,
	dateInsert,
	canceled,
...
create view mart_bx_orders_all_lndc as (SELECT
	id,
	price,
	dateInsert,
	canceled,
...
create view mart_orders_dt_lndc as (SELECT
...
create view mart_sales_dt_lndc as (SELECT
	DATE(dateInsert) AS `DT`,
	0 AS Visits,
	0 AS Costs,
	0 AS Orders,
...
create view mart_mkt_e2e_lndc as (SELECT
	DT,
	Visits,
	Costs,
	Orders,
...
CREATE EVENT mart_mkt_attribution_lndc
