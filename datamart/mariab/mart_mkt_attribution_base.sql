...
create or replace view mart_bx_orders_datetime as (select
    ...
    price, dateInsert, canceled, statusId, xmlId, userDescription
from raw_bx_orders);
...
AND LOCATE('YAMARKET_', xmlId)=0 AND LOCATE('AVITO_', xmlId)=0 AND LOCATE('Заказ поступил с Озона', userDescription)=0
