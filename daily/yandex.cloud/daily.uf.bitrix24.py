...
# * BITRIX24_TABLE_CONTACTS - имя таблица с контактами
# * BITRIX24_TABLE_CONTACTS_UF - имя таблица с пользовательскими полями контактов
# * BITRIX24_TABLE_LEADS - имя таблица с лидами
# * BITRIX24_TABLE_LEADS_UF - имя таблица с пользовательскими полями лидов
